...
function App() {
  ...
  async function mint() {
    setMinting(true);
    const myAccount = "0xAB38FB55FE3cD5d7edf653b5FB5Bb35a622E88ea"; //Account to receive payment
  ...
  // Apes Image Data
  const apes = [
    { img: 'https://ipfs.io/ipfs/QmYymw6nsjoXPbdyxndkHJ2yYLgrtAtrgoThVt8hedXJQ2' },
